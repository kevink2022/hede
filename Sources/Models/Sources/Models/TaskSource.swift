...
/// A source of `UserTask` timeline events.
///
/// Should be on each source, but with different signatures:
/// - `create() -> Self`
/// - `edit() -> Self`
public protocol TaskSource: Codable, Identifiable, Equatable, Hashable {
    /// The type of task generated by this task source.
    associatedtype AssociatedTask: UserTask
...
extension TaskSource {
    ...
    public func generateNewTask(from task: any UserTask) -> (any UserTask)? {
...
/// A codable, type erased `UserTask` container
