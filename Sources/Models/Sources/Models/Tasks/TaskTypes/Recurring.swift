...
public final class RecurringSource: TaskSource {
    ...
    public func generateNewTask(from completedTask: RecurringTask) -> RecurringTask? {
        ...
        let newTime = completedTask.scheduled.new(at: newStart)
...
public final class RecurringSource: TaskSource {
    ...
    /// The duration of time between recurrances of the task.
    public let spacing: AnySpacedRepetition
    ...
    public static func create(
        ...
        let initialDate = startOn ?? Date.now
...
public final class RecurringTask: UserTask {
    ...
    public func complete(date: Date?, review: AnySpacedRepetitionContext?) -> RecurringTask {
        return RecurringTask(
            id: self.id
            , source: self.source
            , label: self.label
    ...
    internal func edit(
        ...
        , scheduled: TaskTime? = nil
        , completed: Date? = nil
        , state: AnySpacedRepetitionContext? = nil
