...
final class TaskBasisTests: XCTestCase {
    ...
    func testCommit() throws {
        ...
        XCTAssertEqual(2, basis_3.taskMap.values.count)
        XCTAssertEqual(2, basis_3.taskSourceMap.values.count)
        XCTAssertEqual(2, basis_3.categoryMap.values.count)
        XCTAssertEqual(2, basis_3.pauseMap.values.count)
    ...
    func testFlatten() throws {
        ...
        // Add more new
        let basis_2 = BasisResolver(TaskBasis()).commit(flattened_2)
        ...
        // Edit
        let basis_3 = BasisResolver(TaskBasis()).commit(flattened_3)
        ...
        // Edit
        let basis_4 = BasisResolver(TaskBasis()).commit(flattened_4)
